  ...
  return (
    <div id="projects" className="my-10 w-p flex flex-col">
      ...
      >
        ...
        >
          <div className="max-w-xxl bg-articon bg-cover bg-center rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div className="hover:opacity-70  min-h-60 bg-white opacity-80 h-full w-full border-2 border-black p-6 rounded-lg">
              ...
              <p className="mb-3 font-medium text-xl text-black ">
                An application that allows you to find famous artworks to use as
                reaction images for various emotions and situations.
              </p>
            </div>
          </div>
        </a>
        <a href="https://github.com/IterationDreamTeam/Co-Sync" target="_blank">
        ...
        <a href="https://github.com/Louka3/personal-bookshelf" target="_blank">
